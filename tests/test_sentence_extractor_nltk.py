...
def test_break_into_sentences_nltk(sample_text_and_word_ids):
    ...
    sentences, word_to_sentence = break_into_sentences(
        text, word_ids, tokenizer=SentenceTokenizer.NLTK
    )
...
def test_break_into_sentences_unsupported_language():
    ...
    sentences, word_to_sentence = break_into_sentences(
        text, word_ids, tokenizer=SentenceTokenizer.NLTK, lang_code="unsupported"
    )
...
def test_break_into_sentences_spacy(sample_text_and_word_ids):
    text, word_ids = sample_text_and_word_ids
    sentences, word_to_sentence = break_into_sentences(
        text, word_ids, tokenizer=SentenceTokenizer.SPACY
    )
