...
class TestFormatLastRead:
    ...
    def test_read_last_minute(self, setup_book):
        book, user = setup_book
        ReadingLoc.objects.create(user=user, book=book, last_access=timezone.now(), page_number=1, word=0)
    ...
    def test_read_minutes_ago(self, setup_book):
        book, user = setup_book
        ReadingLoc.objects.create(user=user, book=book, last_access=timezone.now() - timedelta(minutes=30), page_number=1, word=0)
    ...
    def test_read_hours_ago(self, setup_book):
        book, user = setup_book
        ReadingLoc.objects.create(user=user, book=book, last_access=timezone.now() - timedelta(hours=3), page_number=1, word=0)
    ...
    def test_read_days_ago(self, setup_book):
        book, user = setup_book
        ReadingLoc.objects.create(user=user, book=book, last_access=timezone.now() - timedelta(days=2), page_number=1, word=0)
    ...
    def test_read_weeks_ago(self, setup_book):
        book, user = setup_book
        ReadingLoc.objects.create(user=user, book=book, last_access=timezone.now() - timedelta(weeks=3), page_number=1, word=0)
    ...
    def test_read_months_ago(self, setup_book):
        book, user = setup_book
        ReadingLoc.objects.create(user=user, book=book, last_access=timezone.now() - timedelta(days=100), page_number=1, word=0)
    ...
    def test_read_years_ago(self, setup_book):
        book, user = setup_book
        ReadingLoc.objects.create(user=user, book=book, last_access=timezone.now() - timedelta(days=400), page_number=1, word=0)
