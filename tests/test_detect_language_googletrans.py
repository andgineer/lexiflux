...
@pytest.mark.parametrize("text, expected_lang", [
    ...
    ("The quick brown fox jumps over the lazy dog. This is a longer English text to ensure accuracy.", "en"),
...
def test_confidence_score_real_api():
    ...
    text = "This is a longer English text to ensure high confidence. It contains multiple sentences."
...
def test_mixed_language_text_real_api():
    ...
    assert result in ["hi", "fr", "en"], \
        f"Expected one of ['hi', 'fr', 'en'], but got {result}"
